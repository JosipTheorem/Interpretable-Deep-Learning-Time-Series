...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\dujme\Desktop\dipl\Zadnje poglavlje\Rezultati\Regime_change")
DEFAULT_CONFIG_PATH = Path(__file__).with_name("config_task2.json")
NAMES = ["X1", "X2", "X3", "X4"]
