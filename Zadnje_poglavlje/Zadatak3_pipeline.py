...
DEFAULT_OUTPUT_DIR = Path(r"C:\Users\dujme\Desktop\dipl\Zadnje poglavlje\Rezultati\Smooth_coefficient")
DEFAULT_CONFIG_PATH = Path(__file__).with_name("config_task3.json")
NAMES = ["X1", "X2", "X3", "X4"]
MAIN_TARGET = 1
MAIN_SOURCE = 0
MAIN_LAG = 1
